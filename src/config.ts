export const SITE = {
  name: "Luis Motoni",
  role: "Web Developer",
  description: "Transformo ideas en productos digitales escalables. Especializado en crear experiencias web rápidas y modernas.",
  email: "luismotoni@protonmail.com",
  github: "https://github.com/luismotoni",
  linkedin: "https://linkedin.com/in/luismotoni", 
};
...
export const SKILLS = [
  "JavaScript (ES6+)", "TypeScript", "React", "Astro", "Node.js", "Tailwind CSS", "Git", "Next.js"
];